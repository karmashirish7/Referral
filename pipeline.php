...
$allReferrals = $sb->rpc('get_kanban_data', ['p_role' => $role, 'p_uid' => $uid]);
...
foreach (array_keys($columns) as $status) {
    $kanbanData[$status] = array_values(array_filter($allReferrals, fn($r) => $r['status'] === $status));
}
    ...
    <div class="main-content">
        ...
        <div class="page-body">
            <div class="page-heading">
                <div><h1>Referral Pipeline</h1><p>Manage and progress referrals through each stage.</p></div>
                ...
                <?php foreach ($columns as $status => $info): ?>
                    <div class="kanban-col">
                        ...
                        <div class="kanban-cards">
                            ...
                            <?php endforeach; ?>
                            <?php if (!$kanbanData[$status]): ?><div style="padding:16px;text-align:center;color:#718096;font-size:12px">No referrals</div><?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
    ...
    <div class="modal-box">
        ...
        <form method="POST" action="referrals.php">
            ...
            <div id="qUpfrontGroup" style="display:none;margin-bottom:14px" class="form-group">
                ...
                <span class="form-hint">Partner commission is calculated from this amount × tier rate.</span>
            </div>
            <div class="form-group" style="margin-bottom:14px">
...
function toggleUpfront(s) { document.getElementById('qUpfrontGroup').style.display = s === 'settled' ? 'flex' : 'none'; }
